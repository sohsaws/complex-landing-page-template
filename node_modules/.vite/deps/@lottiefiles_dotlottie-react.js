...
var Y3 = (() => {
  ...
  return function(i = {}) {
    ...
    var c = i, W, V, J = new Promise((t, e) => {
      W = t, V = e;
    }), m1 = Object.assign({}, c), u1 = "./this.program", D = "", l1;
    typeof document < "u" && document.currentScript && (D = document.currentScript.src), h && (D = h), D.startsWith("blob:") ? D = "" : D = D.substr(0, D.replace(/[?#].*/, "").lastIndexOf("/") + 1), l1 = async (t) => {
    ...
    Object.assign(c, m1), m1 = null, c.thisProgram && (u1 = c.thisProgram);
    var i1 = c.wasmBinary, K, _1 = false, f1, B, E, n1, Z, M, C, g1, L1;
    function r1() {
      var t = K.buffer;
      c.HEAP8 = B = new Int8Array(t), c.HEAP16 = n1 = new Int16Array(t), c.HEAPU8 = E = new Uint8Array(t), c.HEAPU16 = Z = new Uint16Array(t), c.HEAP32 = M = new Int32Array(t), c.HEAPU32 = C = new Uint32Array(t), c.HEAPF32 = g1 = new Float32Array(t), c.HEAPF64 = L1 = new Float64Array(t);
    }
    var k1 = [], x = [], w1 = [];
    function n3() {
    ...
    function D1(t) {
      var e;
      throw (e = c.onAbort) === null || e === void 0 || e.call(c, t), t = "Aborted(" + t + ")", q(t), _1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), V(t), t;
    }
    var L2 = (t) => t.startsWith("data:application/octet-stream;base64,"), T1;
    async function a3(t) {
      if (!i1) try {
        var e = await l1(t);
      ...
      if (t == T1 && i1) t = new Uint8Array(i1);
      else throw "both async and sync fetching of the wasm failed";
      return t;
    }
    async function s3(t, e) {
      try {
        var a = await a3(t);
        return await WebAssembly.instantiate(a, e);
      } catch (s) {
        q(`failed to asynchronously prepare wasm: ${s}`), D1(s);
      }
    }
    async function r3(t) {
      var e = T1;
      if (!i1 && typeof WebAssembly.instantiateStreaming == "function" && !L2(e) && typeof fetch == "function") try {
    ...
    }, X1 = c.noExitRuntime || true, M2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, F1 = function() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN;
      var a = E, s = t + e;
      for (e = t; a[e] && !(e >= s); ) ++e;
      if (16 < e - t && a.buffer && M2) return M2.decode(a.subarray(t, e));
      for (s = ""; t < e; ) {
        var r = a[t++];
        if (r & 128) {
          var o = a[t++] & 63;
          if ((r & 224) == 192) s += String.fromCharCode((r & 31) << 6 | o);
          else {
            var l = a[t++] & 63;
            r = (r & 240) == 224 ? (r & 15) << 12 | o << 6 | l : (r & 7) << 18 | o << 12 | l << 6 | a[t++] & 63, 65536 > r ? s += String.fromCharCode(r) : (r -= 65536, s += String.fromCharCode(55296 | r >> 10, 56320 | r & 1023));
          }
    ...
    var v1 = {}, h1 = {}, W1 = {}, b1, a1 = (t, e, a) => {
      function s(u) {
        if (u = a(u), u.length !== t.length) throw new b1("Mismatched type converter count");
        for (var f = 0; f < t.length; ++f) H(t[f], u[f]);
      }
      t.forEach((u) => W1[u] = e);
      var r = Array(e.length), o = [], l = 0;
      e.forEach((u, f) => {
        h1.hasOwnProperty(u) ? r[f] = h1[u] : (o.push(u), v1.hasOwnProperty(u) || (v1[u] = []), v1[u].push(() => {
          r[f] = h1[u], ++l, l === o.length && s(r);
        }));
      }), o.length === 0 && s(r);
    }, C2, A = (t) => {
    ...
    function h3(t, e) {
      ...
      var s = e.name;
      if (!t) throw new w(`type "${s}" must have a positive integer typeid pointer`);
      if (h1.hasOwnProperty(t)) {
        if (a.hb) return;
        throw new w(`Cannot register type '${s}' twice`);
      }
      h1[t] = e, delete W1[t], v1.hasOwnProperty(t) && (e = v1[t], delete v1[t], e.forEach((r) => r()));
    }
    function H(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      return h3(t, e, a);
    ...
    var Z1 = (t) => {
      throw new w(t.Aa.Da.Ba.name + " instance already deleted");
    }, t2 = false, b2 = () => {
    }, I2 = (t, e, a) => e === a ? t : a.Ga === void 0 ? null : (t = I2(t, e, a.Ga), t === null ? null : a.$a(t)), S2 = {}, d3 = {}, c3 = (t, e) => {
      if (e === void 0) throw new w("ptr should not be undefined");
    ...
    var S1 = (t, e) => Object.defineProperty(e, "name", { value: t }), P2 = (t, e, a) => {
      if (t[e].Ea === void 0) {
        ...
        t[e] = function() {
          ...
          if (!t[e].Ea.hasOwnProperty(o.length)) throw new w(`Function '${a}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Ea})!`);
          return t[e].Ea[o.length].apply(this, o);
        }, t[e].Ea = [], t[e].Ea[s.Na] = s;
      }
    }, e2 = (t, e, a) => {
      if (c.hasOwnProperty(t)) {
        if (a === void 0 || c[t].Ea !== void 0 && c[t].Ea[a] !== void 0) throw new w(`Cannot register public name '${t}' twice`);
        if (P2(c, t, t), c[t].Ea.hasOwnProperty(a)) throw new w(`Cannot register multiple overloads of a function with the same number of arguments (${a})!`);
        c[t].Ea[a] = e;
      } else c[t] = e, c[t].Na = a;
    }, u3 = (t) => {
    ...
    function l3(t, e, a, s, r, o, l, u) {
      this.name = t, this.constructor = e, this.Ma = a, this.Ka = s, this.Ga = r, this.bb = o, this.Qa = l, this.$a = u, this.jb = [];
    }
    var i2 = (t, e, a) => {
      for (; e !== a; ) {
        if (!e.Qa) throw new w(`Expected null or instance of ${a.name}, got an instance of ${e.name}`);
        t = e.Qa(t), e = e.Ga;
      }
      return t;
    };
    function _3(t, e) {
      ...
      if (!e.Aa) throw new w(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new w(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function f3(t, e) {
      ...
      if (!e || !e.Aa) throw new w(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new w(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && e.Aa.Da.Ra) throw new w(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
      if (a = i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba), this.Sa) {
        if (e.Aa.Fa === void 0) throw new w("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
            else throw new w(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            a = e.Aa.Fa;
            break;
          case 2:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
              ...
              var s = e.clone();
              a = this.kb(a, z1(() => s.delete())), t !== null && t.push(this.Ka, a);
            }
            break;
          default:
    ...
    function v3(t, e) {
      ...
      if (!e.Aa) throw new w(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new w(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (e.Aa.Da.Ra) throw new w(`Cannot convert argument of type ${e.Aa.Da.name} to parameter type ${this.name}`);
      return i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba);
    }
    function P1(t, e, a, s, r, o, l, u, f, m, v) {
      this.name = t, this.Ba = e, this.Ta = a, this.Ra = s, this.Sa = r, this.ib = o, this.ob = l, this.Ya = u, this.Ua = f, this.kb = m, this.Ka = v, r || e.Ga !== void 0 ? this.toWireType = f3 : (this.toWireType = s ? _3 : v3, this.Ja = null);
    }
    var E2 = (t, e, a) => {
      ...
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, c["dynCall_" + t])(e, ...a)) : e = $.get(e)(...a), e;
    }, m3 = (t, e) => function() {
      for (var a = arguments.length, s = new Array(a), r = 0; r < a; r++) s[r] = arguments[r];
      return p3(t, e, s);
    }, T = (t, e) => {
      t = A(t);
      var a = t.includes("j") ? m3(t, e) : $.get(e);
      if (typeof a != "function") throw new w(`unknown function pointer with signature ${t}: ${e}`);
      return a;
    }, O2, A2 = (t) => {
      t = z2(t);
      var e = A(t);
      ...
      function a(o) {
        r[o] || h1[o] || (W1[o] ? W1[o].forEach(a) : (s.push(o), r[o] = true));
      }
      var s = [], r = {};
      throw e.forEach(a), new O2(`${t}: ` + s.map(A2).join([", "]));
    }, n2 = (t, e) => {
      for (var a = [], s = 0; s < t; s++) a.push(C[e + 4 * s >> 2]);
      return a;
    };
    function g3(t) {
    ...
    function a2(t, e, a, s, r) {
      var o = e.length;
      if (2 > o) throw new w("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var l = e[1] !== null && a !== null, u = g3(e), f = e[0].name !== "void", m = o - 2, v = Array(m), y = [], b = [];
      return S1(t, function() {
        for (var U = arguments.length, S = new Array(U), j = 0; j < U; j++) S[j] = arguments[j];
        if (b.length = 0, y.length = l ? 2 : 1, y[0] = r, l) {
    ...
    var k2 = (t) => {
      ...
      9 < t && --t1[t + 1] === 0 && (t1[t] = void 0, s2.push(t));
    }, p1 = (t) => {
      if (!t) throw new w("Cannot use deleted val. handle = " + t);
      return t1[t];
    }, z1 = (t) => {
      switch (t) {
        case void 0:
        ...
        case false:
          return 8;
        default:
          let e = s2.pop() || t1.length;
          return t1[e] = t, t1[e + 1] = 1, e;
      }
    }, D2 = { name: "emscripten::val", fromWireType: (t) => {
      var e = p1(t);
      return r2(t), e;
    }, toWireType: (t, e) => z1(e), Ia: 8, readValueFromPointer: C1, Ja: null }, L3 = (t, e, a) => {
      switch (e) {
        case 1:
          return a ? function(s) {
        ...
        case 4:
          return a ? function(s) {
            return this.fromWireType(M[s >> 2]);
          } : function(s) {
      ...
      var a = h1[t];
      if (a === void 0) throw t = `${e} has unknown type ${A2(t)}`, new w(t);
      return a;
    }, o2 = (t) => {
      ...
      switch (e) {
        case 1:
          return a ? (s) => B[s] : (s) => E[s];
        case 2:
          return a ? (s) => n1[s >> 1] : (s) => Z[s >> 1];
        case 4:
          return a ? (s) => M[s >> 2] : (s) => C[s >> 2];
        default:
          throw new TypeError(`invalid integer width (${e}): ${t}`);
      }
    }, y3 = Object.assign({ optional: true }, D2), T2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, C3 = (t, e) => {
      for (var a = t >> 1, s = a + e / 2; !(a >= s) && Z[a]; ) ++a;
      if (a <<= 1, 32 < a - t && T2) return T2.decode(E.subarray(t, a));
      for (a = "", s = 0; !(s >= e / 2); ++s) {
        var r = n1[t + 2 * s >> 1];
        if (r == 0) break;
      ...
      var s;
      if ((s = a) !== null && s !== void 0 || (a = 2147483647), 2 > a) return 0;
      a -= 2;
      var r = e;
      ...
      for (var a = 0, s = ""; !(a >= e / 4); ) {
        var r = M[t + 4 * a >> 2];
        if (r == 0) break;
        ++a, 65536 <= r ? (r -= 65536, s += String.fromCharCode(55296 | r >> 10, 56320 | r & 1023)) : s += String.fromCharCode(r);
      }
      return s;
    }, P3 = (t, e, a) => {
      var s;
      if ((s = a) !== null && s !== void 0 || (a = 2147483647), 4 > a) return 0;
      var r = e;
      a = r + a - 4;
      for (var o = 0; o < t.length; ++o) {
        ...
        if (M[e >> 2] = l, e += 4, e + 4 > a) break;
      }
      return M[e >> 2] = 0, e - r;
    }, E3 = (t) => {
      for (var e = 0, a = 0; a < t.length; ++a) {
        var s = t.charCodeAt(a);
        55296 <= s && 57343 >= s && ++a, e += 4;
      }
      return e;
    }, h2 = 0, F2 = (t, e, a) => {
      var s = [];
      return t = t.toWireType(s, a), s.length && (C[e >> 2] = z1(s)), t;
    }, d2 = [], O3 = (t) => {
      var e = d2.length;
      return d2.push(t), e;
    }, A3 = (t, e) => {
      for (var a = Array(t), s = 0; s < t; ++s) a[s] = B1(C[e + 4 * s >> 2], "parameter " + s);
      return a;
    }, k3 = Reflect.construct, E1 = {}, R2 = (t) => {
      if (!(t instanceof w2 || t == "unwind")) throw t;
    }, W2 = (t) => {
      var e;
      throw f1 = t, X1 || 0 < h2 || ((e = c.onExit) !== null && e !== void 0 && e.call(c, t), _1 = true), new w2(t);
    }, D3 = (t) => {
      if (!_1) try {
        if (t(), !(X1 || 0 < h2)) try {
          f1 = t = f1, W2(t);
    ...
    for (var U2 = Array(256), H1 = 0; 256 > H1; ++H1) U2[H1] = String.fromCharCode(H1);
    C2 = U2, w = c.BindingError = class extends Error {
      constructor(t) {
      ...
      var t = I1, e = Object, a = e.create, s = Object.getPrototypeOf(this), r = this.Aa;
      return t = t(a.call(e, s, { Aa: { value: { count: r.count, Oa: r.Oa, Pa: r.Pa, Ca: r.Ca, Da: r.Da, Fa: r.Fa, Ha: r.Ha } } })), t.Aa.count.value += 1, t.Aa.Oa = false, t;
    }, delete() {
      if (this.Aa.Ca || Z1(this), this.Aa.Oa && !this.Aa.Pa) throw new w("Object already scheduled for deletion");
      b2(this);
      var t = this.Aa;
      ...
      var s = c3(this.Ba, a);
      if (s !== void 0) return s.Aa.count.value === 0 ? (s.Aa.Ca = a, s.Aa.Fa = t, s.clone()) : (s = s.clone(), this.Wa(t), s);
      if (s = this.Ba.bb(a), s = S2[s], !s) return e.call(this);
      s = this.Ra ? s.Za : s.pointerType;
      var r = I2(a, this.Ba, s.Ba);
      return r === null ? e.call(this) : this.Sa ? x1(s.Ba.Ma, { Da: s, Ca: r, Ha: this, Fa: t }) : x1(s.Ba.Ma, { Da: s, Ca: r });
    } }), O2 = c.UnboundTypeError = ((t, e) => {
      var a = S1(e, function(s) {
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    })(Error, "UnboundTypeError"), t1.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), c.count_emval_handles = () => t1.length / 2 - 5 - s2.length;
    var F3 = { c: (t, e, a, s) => D1(`Assertion failed: ${t ? F1(t) : ""}, at: ` + [e ? e ? F1(e) : "" : "unknown filename", a, s ? s ? F1(s) : "" : "unknown function"]), j: (t, e, a) => {
      var s = new o3(t);
      throw C[s.Ca + 16 >> 2] = 0, C[s.Ca + 4 >> 2] = e, C[s.Ca + 8 >> 2] = a, y2 = t, y2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      var e = R1[t];
      delete R1[t];
      var a = e.Ua, s = e.Ka, r = e.Xa, o = r.map((l) => l.gb).concat(r.map((l) => l.mb));
      a1([t], o, (l) => {
        var u = {};
        return r.forEach((f, m) => {
          var v = l[m], y = f.eb, b = f.fb, U = l[m + r.length], S = f.lb, j = f.nb;
          u[f.ab] = { read: (R) => v.fromWireType(y(b, R)), write: (R, P) => {
            var F = [];
            S(j, R, U.toWireType(F, P)), Y1(F);
          } };
        }), [{ name: e.name, fromWireType: (f) => {
          var m = {}, v;
          for (v in u) m[v] = u[v].read(f);
          return s(f), m;
        }, toWireType: (f, m) => {
          for (var v in u) if (!(v in m)) throw new TypeError(`Missing field: "${v}"`);
          var y = a();
          for (v in u) u[v].write(y, m[v]);
          return f !== null && f.push(s, y), y;
        }, Ia: 8, readValueFromPointer: C1, Ja: s }];
      });
    }, F: () => {
    }, _: (t, e, a, s) => {
      e = A(e), H(t, { name: e, fromWireType: function(r) {
        return !!r;
      }, toWireType: function(r, o) {
        return o ? a : s;
      }, Ia: 8, readValueFromPointer: function(r) {
        return this.fromWireType(E[r]);
      }, Ja: null });
    }, k: (t, e, a, s, r, o, l, u, f, m, v, y, b) => {
      v = A(v), o = T(r, o), u && (u = T(l, u)), m && (m = T(f, m)), b = T(y, b);
      var U = u3(v);
      e2(U, function() {
        U1(`Cannot construct ${v} due to unbound types`, [s]);
      }), a1([t, e, a], s ? [s] : [], (S) => {
        if (S = S[0], s) var j = S.Ba, R = j.Ma;
        else R = $1.prototype;
        S = S1(v, function() {
          if (Object.getPrototypeOf(this) !== P) throw new w("Use 'new' to construct " + v);
          if (F.La === void 0) throw new w(v + " has no accessible constructor");
          for (var N2 = arguments.length, N1 = new Array(N2), G1 = 0; G1 < N2; G1++) N1[G1] = arguments[G1];
          var G2 = F.La[N1.length];
          if (G2 === void 0) throw new w(`Tried to invoke ctor of ${v} with invalid number of parameters (${N1.length}) - expected (${Object.keys(F.La).toString()}) parameters instead!`);
          return G2.apply(this, N1);
        });
        var P = Object.create(R, { constructor: { value: S } });
        S.prototype = P;
        var F = new l3(v, S, P, b, j, o, u, m);
        if (F.Ga) {
          var j2, O1;
          (j2 = (O1 = F.Ga).Va) !== null && j2 !== void 0 || (O1.Va = []), F.Ga.Va.push(F);
        }
        return j = new P1(v, F, true, false, false), O1 = new P1(v + "*", F, false, false, false), R = new P1(v + " const*", F, false, true, false), S2[t] = { pointerType: O1, Za: R }, E2(U, S), [j, O1, R];
      });
    }, r: (t, e, a, s, r, o) => {
      var l = n2(e, a);
      r = T(s, r), a1([], [t], (u) => {
        ...
        if (u.Ba.La === void 0 && (u.Ba.La = []), u.Ba.La[e - 1] !== void 0) throw new w(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${u.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return u.Ba.La[e - 1] = () => {
          U1(`Cannot construct ${u.name} due to unbound types`, l);
        }, a1([], l, (m) => (m.splice(1, 0, null), u.Ba.La[e - 1] = a2(f, m, null, r, o), [])), [];
      });
    }, d: (t, e, a, s, r, o, l, u) => {
      var f = n2(a, s);
      e = A(e), e = k2(e), o = T(r, o), a1([], [t], (m) => {
        function v() {
          U1(`Cannot call ${y} due to unbound types`, f);
        }
        m = m[0];
        var y = `${m.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), u && m.Ba.jb.push(e);
        var b = m.Ba.Ma, U = b[e];
    ...
    }, Y: (t) => H(t, D2), D: (t, e, a, s) => {
      function r() {
      }
      e = A(e), r.values = {}, H(t, { name: e, constructor: r, fromWireType: function(o) {
        return this.constructor.values[o];
      }, toWireType: (o, l) => l.value, Ia: 8, readValueFromPointer: L3(e, a, s), Ja: null }), e2(e, r);
    }, m: (t, e, a) => {
      var s = B1(t, "enum");
      e = A(e), t = s.constructor, s = Object.create(s.constructor.prototype, { value: { value: a }, constructor: { value: S1(`${s.name}_${e}`, function() {
      }) } }), t.values[a] = s, t[e] = s;
    }, A: (t, e, a) => {
      e = A(e), H(t, { name: e, fromWireType: (s) => s, toWireType: (s, r) => r, Ia: 8, readValueFromPointer: w3(e, a), Ja: null });
    }, u: (t, e, a, s, r, o) => {
      var l = n2(e, a);
      t = A(t), t = k2(t), r = T(s, r), e2(t, function() {
        U1(`Cannot call ${t} due to unbound types`, l);
      }, e - 1), a1([], l, (u) => (E2(t, a2(t, [u[0], null].concat(u.slice(1)), null, r, o), e - 1), []));
    }, n: (t, e, a, s, r) => {
      if (e = A(e), r === -1 && (r = 4294967295), r = (u) => u, s === 0) {
        var o = 32 - 8 * a;
        r = (u) => u << o >>> o;
      }
      var l = e.includes("unsigned") ? function(u, f) {
        return f >>> 0;
      } : function(u, f) {
        return f;
      };
      H(t, { name: e, fromWireType: r, toWireType: l, Ia: 8, readValueFromPointer: M3(e, a, s !== 0), Ja: null });
    }, g: (t, e, a) => {
      function s(o) {
        return new r(B.buffer, C[o + 4 >> 2], C[o >> 2]);
      }
      var r = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][e];
      a = A(a), H(t, { name: a, fromWireType: s, Ia: 8, readValueFromPointer: s }, { hb: true });
    }, o: (t) => {
      H(t, y3);
    }, v: (t, e, a, s, r, o, l, u, f, m, v, y) => {
      a = A(a), o = T(r, o), u = T(l, u), m = T(f, m), y = T(v, y), a1([t], [e], (b) => (b = b[0], [new P1(a, b.Ba, false, false, true, b, s, o, u, m, y)]));
    }, Z: (t, e) => {
      e = A(e), H(t, { name: e, fromWireType: function(a) {
        for (var s = C[a >> 2], r = a + 4, o, l = r, u = 0; u <= s; ++u) {
          var f = r + u;
          (u == s || E[f] == 0) && (l = l ? F1(l, f - l) : "", o === void 0 ? o = l : (o += "\0", o += l), l = f + 1);
        }
        return e1(a), o;
      }, toWireType: function(a, s) {
        s instanceof ArrayBuffer && (s = new Uint8Array(s));
        var r, o = typeof s == "string";
        if (!(o || s instanceof Uint8Array || s instanceof Uint8ClampedArray || s instanceof Int8Array)) throw new w("Cannot pass non-string to std::string");
        if (o) for (var l = r = 0; l < s.length; ++l) {
          var u = s.charCodeAt(l);
          127 >= u ? r++ : 2047 >= u ? r += 2 : 55296 <= u && 57343 >= u ? (r += 4, ++l) : r += 3;
        }
        else r = s.length;
        if (l = l2(4 + r + 1), u = l + 4, C[l >> 2] = r, o) y1(s, u, r + 1);
        else if (o) for (o = 0; o < r; ++o) {
          var f = s.charCodeAt(o);
          if (255 < f) throw e1(u), new w("String has UTF-16 code units that do not fit in 8 bits");
          E[u + o] = f;
        }
        else for (o = 0; o < r; ++o) E[u + o] = s[o];
        return a !== null && a.push(e1, l), l;
      }, Ia: 8, readValueFromPointer: C1, Ja(a) {
        e1(a);
      } });
    }, y: (t, e, a) => {
      if (a = A(a), e === 2) var s = C3, r = b3, o = I3, l = (u) => Z[u >> 1];
      else e === 4 && (s = S3, r = P3, o = E3, l = (u) => C[u >> 2]);
      H(t, { name: a, fromWireType: (u) => {
        for (var f = C[u >> 2], m, v = u + 4, y = 0; y <= f; ++y) {
          var b = u + 4 + y * e;
          (y == f || l(b) == 0) && (v = s(v, b - v), m === void 0 ? m = v : (m += "\0", m += v), v = b + e);
        }
        return e1(u), m;
      }, toWireType: (u, f) => {
        if (typeof f != "string") throw new w(`Cannot pass non-string to C++ string type ${a}`);
        var m = o(f), v = l2(4 + m + e);
        return C[v >> 2] = m / e, r(f, v + 4, m + e), u !== null && u.push(e1, v), v;
      }, Ia: 8, readValueFromPointer: C1, Ja(u) {
        e1(u);
      } });
    }, x: (t, e, a, s, r, o) => {
      R1[t] = { name: A(e), Ua: T(a, s), Ka: T(r, o), Xa: [] };
    }, i: (t, e, a, s, r, o, l, u, f, m) => {
      R1[t].Xa.push({ ab: A(e), gb: a, eb: T(s, r), fb: o, mb: l, lb: T(u, f), nb: m });
    }, $: (t, e) => {
      e = A(e), H(t, { pb: true, name: e, Ia: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, K: () => {
      X1 = false, h2 = 0;
      ...
      throw 1 / 0;
    }, C: (t, e, a) => (t = p1(t), e = B1(e, "emval::as"), F2(e, a, t)), q: (t, e, a, s) => (t = d2[t], e = p1(e), t(null, e, a, s)), W: r2, E: (t, e) => (t = p1(t), e = p1(e), t == e), p: (t, e, a) => {
      var s = A3(t, e), r = s.shift();
      t--;
      var o = Array(t);
      return e = `methodCaller<(${s.map((l) => l.name).join(", ")}) => ${r.name}>`, O3(S1(e, (l, u, f, m) => {
        for (var v = 0, y = 0; y < t; ++y) o[y] = s[y].readValueFromPointer(m + v), v += s[y].Ia;
        return l = a === 1 ? k3(u, o) : u.apply(l, o), F2(r, f, l);
      }));
    }, z: (t) => {
      9 < t && (t1[t + 1] += 1);
    }, ca: (t) => {
      var e = p1(t);
      Y1(e), r2(t);
    }, s: (t, e) => (t = B1(t, "_emval_take_value"), t = t.readValueFromPointer(e), z1(t)), G: (t, e) => {
      if (E1[t] && (clearTimeout(E1[t].id), delete E1[t]), !e) return 0;
      var a = setTimeout(() => {
        delete E1[t], D3(() => B2(t, performance.now()));
      }, e);
      return E1[t] = { id: a, qb: e }, 0;
    }, H: (t, e, a, s) => {
      var r = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(r, 0, 1).getTimezoneOffset();
      r = new Date(r, 6, 1).getTimezoneOffset(), C[t >> 2] = 60 * Math.max(o, r), M[e >> 2] = +(o != r), e = (l) => {
        var u = Math.abs(l);
        return `UTC${0 <= l ? "-" : "+"}${String(Math.floor(u / 60)).padStart(2, "0")}${String(u % 60).padStart(2, "0")}`;
      }, t = e(o), e = e(r), r < o ? (y1(t, a, 17), y1(e, s, 17)) : (y1(t, s, 17), y1(e, a, 17));
      ...
      for (var a = 1; 4 >= a; a *= 2) {
        ...
        t: {
          s = (Math.min(2147483648, 65536 * Math.ceil(Math.max(t, s) / 65536)) - K.buffer.byteLength + 65535) / 65536 | 0;
          try {
            K.grow(s), r1();
            var r = 1;
            break t;
      ...
      var a = 0;
      return x2().forEach((s, r) => {
        var o = e + a;
        for (r = C[t + 4 * r >> 2] = o, o = 0; o < s.length; ++o) B[r++] = s.charCodeAt(o);
        B[r] = 0, a += s.length + 1;
      }), 0;
    }, X: (t, e) => {
      var a = x2();
      C[t >> 2] = a.length;
      var s = 0;
      return a.forEach((r) => s += r.length + 1), C[e >> 2] = s, 0;
    }, S: () => 52, Q: () => 52, l: R3, f: U3, e: H3, B: W3, aa: B3, a: x3, b: z3, h: $3, t: j3, U: W2, L: (t, e) => ($2(E.subarray(t, t + e)), 0) }, I;
    (async function(t, e) {
      function a(o) {
        var l;
        return I = o.exports, K = I.da, r1(), $ = I.ga, x.unshift(I.ea), o1--, (l = c.monitorRunDependencies) === null || l === void 0 || l.call(c, o1), o1 == 0 && M1 && (o = M1, M1 = null, o()), I;
      }
      o1++, (t = c.monitorRunDependencies) === null || t === void 0 || t.call(c, o1);
      var s = { a: F3 };
      if (c.instantiateWasm) try {
        return c.instantiateWasm(s, a);
      } catch (o) {
        q(`Module.instantiateWasm callback failed with error: ${o}`), V(o);
      }
      (e = T1) !== null && e !== void 0 || (T1 = L2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : c.locateFile ? c.locateFile("DotLottiePlayer.wasm", D) : D + "DotLottiePlayer.wasm");
      try {
        var r = await r3(s);
        return a(r.instance), r;
      } catch (o) {
        V(o);
      }
    })();
    var l2 = (t) => (l2 = I.fa)(t), e1 = (t) => (e1 = I.ha)(t), z2 = (t) => (z2 = I.ia)(t), B2 = (t, e) => (B2 = I.ja)(t, e), Q = (t, e) => (Q = I.ka)(t, e), X = (t) => (X = I.la)(t), Y = () => (Y = I.ma)();
    c.dynCall_jiii = (t, e, a, s) => (c.dynCall_jiii = I.na)(t, e, a, s), c.dynCall_jii = (t, e, a) => (c.dynCall_jii = I.oa)(t, e, a), c.dynCall_vjii = (t, e, a, s, r) => (c.dynCall_vjii = I.pa)(t, e, a, s, r), c.dynCall_vjfii = (t, e, a, s, r, o) => (c.dynCall_vjfii = I.qa)(t, e, a, s, r, o), c.dynCall_vjiii = (t, e, a, s, r, o) => (c.dynCall_vjiii = I.ra)(t, e, a, s, r, o), c.dynCall_vj = (t, e, a) => (c.dynCall_vj = I.sa)(t, e, a), c.dynCall_vjiiiii = (t, e, a, s, r, o, l, u) => (c.dynCall_vjiiiii = I.ta)(t, e, a, s, r, o, l, u), c.dynCall_vjiffii = (t, e, a, s, r, o, l, u) => (c.dynCall_vjiffii = I.ua)(t, e, a, s, r, o, l, u), c.dynCall_vjiiii = (t, e, a, s, r, o, l) => (c.dynCall_vjiiii = I.va)(t, e, a, s, r, o, l), c.dynCall_viijii = (t, e, a, s, r, o, l) => (c.dynCall_viijii = I.wa)(t, e, a, s, r, o, l), c.dynCall_iiiiij = (t, e, a, s, r, o, l) => (c.dynCall_iiiiij = I.xa)(t, e, a, s, r, o, l), c.dynCall_iiiiijj = (t, e, a, s, r, o, l, u, f) => (c.dynCall_iiiiijj = I.ya)(t, e, a, s, r, o, l, u, f), c.dynCall_iiiiiijj = (t, e, a, s, r, o, l, u, f, m) => (c.dynCall_iiiiiijj = I.za)(t, e, a, s, r, o, l, u, f, m);
    function R3(t, e) {
      var a = Y();
      try {
        return $.get(t)(e);
      } catch (s) {
        if (X(a), s !== s + 0) throw s;
        Q(1, 0);
      }
    }
    function W3(t, e, a, s, r, o) {
      var l = Y();
      try {
        return $.get(t)(e, a, s, r, o);
      } catch (u) {
        if (X(l), u !== u + 0) throw u;
        Q(1, 0);
      }
    }
    function x3(t, e) {
    ...
    function H2() {
      function t() {
        if (!j1 && (j1 = true, c.calledRun = true, !_1)) {
          var e;
          if (Q1(x), W(c), (e = c.onRuntimeInitialized) === null || e === void 0 || e.call(c), c.postRun) for (typeof c.postRun == "function" && (c.postRun = [c.postRun]); c.postRun.length; ) {
      ...
      if (!(0 < o1)) {
        if (c.preRun) for (typeof c.preRun == "function" && (c.preRun = [c.preRun]); c.preRun.length; ) n3();
        Q1(k1), 0 < o1 || (c.setStatus ? (c.setStatus("Running..."), setTimeout(() => {
...
function z(h) {
  ...
  if (i instanceof HTMLCanvasElement) {
    ...
    let d = i.width / n.width, _ = i.height / n.height, g = (h.clientX - n.left) * d, c = (h.clientY - n.top) * _;
    return !Number.isFinite(g) || !Number.isFinite(c) || Number.isNaN(g) || Number.isNaN(c) ? null : { x: g, y: c };
  }
  return null;
}
function t3(h) {
...
var K2 = (h, i) => {
  ...
  for (let _ = 0; _ < d.length; _ += 1) {
    let g = d[_];
    g !== void 0 && typeof g == "number" && n.push_back(g);
  }
  return n;
};
...
var e3 = class L {
  ...
  _loadFromData(i) {
    if (this._dotLottieCore === null || L._wasmModule === null) return;
    if (!this._canvas) {
    ...
    if (typeof i == "string") {
      ...
      _ = this._dotLottieCore.loadDotLottieData(K2(L._wasmModule, i), n, d);
  ...
  load(i) {
    this._dotLottieCore === null || L._wasmModule === null || (this._stopAnimationLoop(), this._cleanupCanvas(), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, loopCount: i.loopCount ?? 0, mode: f2(i.mode ?? "forward", L._wasmModule), segment: v2(i.segment ?? [], L._wasmModule), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: p2(i.layout, L._wasmModule) }), i.data ? this._canvas ? this._loadFromData(i.data) : this._pendingLoad = { data: i.data } : i.src && (this._canvas ? this._loadFromSrc(i.src) : this._pendingLoad = { src: i.src }), this.setBackgroundColor(i.backgroundColor ?? ""));
  }
  _draw() {
  ...
  _cleanupCanvas() {
    this._canvas && O && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas), this._cleanupStateMachineListeners());
  }
  _initializeCanvas() {
    this._context = null, this._canvas && O && this._canvas instanceof HTMLCanvasElement && this.isLoaded && (this._renderConfig.freezeOnOffscreen && (N.observe(this._canvas, this), c1(this._canvas) || this.freeze()), this._renderConfig.autoResize && G.observe(this._canvas, this), this._isStateMachineRunning && this._setupStateMachineListeners()), this._canvas && this._dotLottieCore && this.isLoaded && this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
  }
  _stopAnimationLoop() {
  ...
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), this._canvas && O && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !c1(this._canvas) && this.freeze());
  }
  pause() {
  ...
  setCanvas(i) {
    if (!(!i || this._canvas === i) && (this._canvas && this._cleanupCanvas(), this._canvas = i, this._initializeCanvas(), this._pendingLoad)) {
      let n = this._pendingLoad;
      this._pendingLoad = null, n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src);
    }
  }
  setTransform(i) {
  ...
  setRenderConfig(i) {
    let { devicePixelRatio: n, freezeOnOffscreen: d, quality: _, ...g } = i;
    this._renderConfig = { ...this._renderConfig, ...g, devicePixelRatio: n || d1(), freezeOnOffscreen: d ?? true, ..._ !== void 0 && { quality: _ } }, _ !== void 0 && this._dotLottieCore && this._dotLottieCore.setQuality(_), O && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), c1(this._canvas) || this.freeze()) : (N.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(i) {
    this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === i || !this._canvas || this._dotLottieCore.loadAnimation(i, this._canvas.width, this._canvas.height) && (this._renderConfig.quality !== void 0 && this._dotLottieCore.setQuality(this._renderConfig.quality), this.resize());
  }
  setMarker(i) {
  ...
  static async registerFont(i, n) {
    try {
      ...
      if (typeof n == "string") {
        let c = await fetch(n);
        if (!c.ok) return console.error(`Failed to fetch font from URL: ${n}. Status: ${c.status}`), false;
        _ = await c.arrayBuffer();
      } else if (n instanceof Uint8Array) {
        let c = n.buffer.slice(n.byteOffset, n.byteOffset + n.byteLength);
        c instanceof ArrayBuffer ? _ = c : (_ = new ArrayBuffer(n.byteLength), new Uint8Array(_).set(n));
      } else _ = n;
      let g = d.registerFont(i, K2(d, _));
      return g || console.error(`Failed to register font "${i}". Font data may be invalid.`), g;
    } catch (d) {
  ...
  tween(i, n) {
    ...
    let d = [0, 0, 1, 1], _ = new L._wasmModule.VectorFloat();
    for (let g of d) _.push_back(g);
  ...
  _setupStateMachineObservers() {
    ...
    }), i.setOnBooleanInputValueChange((d, _, g) => {
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: d, newValue: g, oldValue: _ });
    }), i.setOnNumericInputValueChange((d, _, g) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: d, newValue: g, oldValue: _ });
    }), i.setOnStringInputValueChange((d, _, g) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: d, newValue: g, oldValue: _ });
    }), i.setOnInputFired((d) => {
  ...
  stateMachineStart() {
    ...
    if (this._stateMachineConfig) {
      ...
      if (d && typeof d.requireUserInteraction == "boolean" && (i.requireUserInteraction = d.requireUserInteraction), d?.whitelist) {
...
var r0 = class {
  ...
  getWorker(h) {
    return this._workers.has(h) || this._workers.set(h, new s0()), this._workers.get(h);
  }
...
function Q2(h, i) {
  if (typeof HTMLCanvasElement < "u" && h instanceof HTMLCanvasElement) {
...
var g2 = class s1 {
  ...
  async _create(i) {
    ...
    let { instanceId: d } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: n }, ...Q2(this._canvas, i.renderConfig?.devicePixelRatio || d1()) }, [n]);
  ...
  async setCanvas(i) {
    let n = typeof HTMLCanvasElement < "u" && i instanceof HTMLCanvasElement, d = typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas;
    if (!n && !d) throw new Error("Worker-based DotLottie requires HTMLCanvasElement or OffscreenCanvas");
    if (this._canvas !== i) {
      if (this._created && this._canvas !== null) throw new Error("Cannot change canvas after worker instance is already created with a different canvas.");
      this._canvas = i, !this._created && this._pendingConfig && (await this._create(this._pendingConfig), this._pendingConfig = null);
    }
  }
  get autoplay() {
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), O && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !c1(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setRenderConfig(i) {
    ...
    let { devicePixelRatio: n, freezeOnOffscreen: d, quality: _, ...g } = i;
    await this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...g, devicePixelRatio: n || d1(), freezeOnOffscreen: d ?? true, ..._ !== void 0 && { quality: _ } } }), await this._updateDotLottieInstanceState(), O && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), c1(this._canvas) || await this.freeze()) : (N.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  ...
  async load(i) {
    if (!this._created) {
      this._pendingConfig && (this._pendingConfig = { ...this._pendingConfig, ...i });
      return;
    }
    await this._sendMessage("load", { config: i, instanceId: this._id }), await this._updateDotLottieInstanceState();
  }
  async setLoop(i) {
  ...
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), s1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), O && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async _sendMessage(i, n, d) {
    let _ = { id: `dotlottie-request-${m2()}`, method: i, params: n };
    return this._worker.postMessage(_, d || []), new Promise((g, c) => {
      let W = (V) => {
        let J = V.data;
        J.id === _.id && (this._worker.removeEventListener("message", W), J.error ? c(new Error(`Failed to execute method ${i}: ${J.error}`)) : g(J.result));
      };
  ...
  static async registerFont(i, n) {
    try {
      let d = m2();
      return s1._workerManager.broadcastMessage({ id: d, method: "registerFont", params: { fontName: i, fontSource: n } }), true;
    } catch (d) {
...
p(g2, "_workerManager", new r0()), p(g2, "_wasmUrl", "");
var J1 = g2;
var K1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: d, createDotLottie: _, data: g, dotLottieRefCallback: c, layout: W, loop: V, mode: J, playOnHover: m1, renderConfig: u1, segment: D, speed: l1, src: q, stateMachineConfig: i1, stateMachineId: K, style: _1, themeData: f1, themeId: B, useFrameInterpolation: E, workerId: n1, ...Z }) => {
  let M = (0, import_react.useRef)(null), C = (0, import_react.useRef)(null), g1 = (0, import_react.useRef)(c), L1 = { speed: l1, mode: J, loop: V, useFrameInterpolation: E, segment: D, backgroundColor: n, autoplay: i, themeId: B, workerId: n1, src: q, data: g, layout: W, renderConfig: u1, animationId: h, stateMachineConfig: i1, stateMachineId: K }, r1 = (0, import_react.useRef)(L1);
  g1.current = c, r1.current = L1;
  let k1 = (0, import_react.useCallback)((x) => {
    C.current = x, x ? M.current = _({ ...r1.current, canvas: x }) : (M.current?.destroy(), M.current = null), g1.current?.(M.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    let x = (w1) => {
      m1 && (w1.type === "mouseenter" && M.current?.play(), w1.type === "mouseleave" && M.current?.pause());
    };
    ...
    M.current?.setSpeed(l1 ?? 1);
  }, [l1]), (0, import_react.useEffect)(() => {
    M.current?.setMode(J ?? "forward");
  }, [J]), (0, import_react.useEffect)(() => {
    M.current?.setLoop(V ?? false);
  }, [V]), (0, import_react.useEffect)(() => {
    M.current?.setUseFrameInterpolation(E ?? true);
  }, [E]), (0, import_react.useEffect)(() => {
    typeof D?.[0] == "number" && typeof D[1] == "number" && M.current?.setSegment(D[0], D[1]);
  }, [D]), (0, import_react.useEffect)(() => {
    M.current?.setBackgroundColor(n ?? "");
  }, [n]), (0, import_react.useEffect)(() => {
    M.current?.setRenderConfig(u1 ?? {});
  }, [JSON.stringify(u1)]), (0, import_react.useEffect)(() => {
    typeof g != "string" && typeof g != "object" || M.current?.load({ data: g, ...r1.current });
  }, [g]), (0, import_react.useEffect)(() => {
    typeof q == "string" && M.current?.load({ src: q, ...r1.current });
  }, [q]), (0, import_react.useEffect)(() => {
    M.current?.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    M.current?.loadAnimation(h ?? "");
  }, [h]), (0, import_react.useEffect)(() => {
    typeof B == "string" && M.current?.setTheme(B);
  }, [B]), (0, import_react.useEffect)(() => {
    M.current?.setThemeData(f1 ?? "");
  }, [f1]), (0, import_react.useEffect)(() => {
    M.current?.setLayout(W ?? {});
  }, [W?.fit, W?.align && W.align[0], W?.align && W.align[1]]), (0, import_react.useEffect)(() => {
    M.current?.isLoaded && (typeof K == "string" && K ? M.current.stateMachineLoad(K) && M.current.stateMachineStart() : M.current.stateMachineStop());
  }, [K]), (0, import_react.useEffect)(() => {
    M.current?.stateMachineSetConfig(i1 ?? null);
  }, [i1]), (0, import_jsx_runtime.jsx)("div", { className: d, ...!d && { style: { width: "100%", height: "100%", lineHeight: 0, ..._1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: k1, style: { width: "100%", height: "100%" }, ...Z }) });
};
var h0 = (h) => new V1(h);
var O0 = (h) => (0, import_jsx_runtime.jsx)(K1, { ...h, createDotLottie: h0 });
var c0 = (h) => new J1(h);
var F0 = (h) => (0, import_jsx_runtime.jsx)(K1, { ...h, createDotLottie: c0 });
var $0 = (h) => {
  J1.setWasmUrl(h), V1.setWasmUrl(h);
};
export {
  O0 as DotLottieReact,
  F0 as DotLottieWorkerReact,
  $0 as setWasmUrl
};
